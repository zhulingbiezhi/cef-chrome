...
{
	CCefSetting::browser_sub_process_path.FromString(path.toLatin1().data());
}
...
{
	CCefSetting::resource_directory_path.FromString(path.toLatin1().data());
}
...
{
	CCefSetting::locales_directory_path.FromString(path.toLatin1().data());
}
...
{
	CCefSetting::user_agent.FromString(agent.toLatin1().data());
}
