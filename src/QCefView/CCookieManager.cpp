...
#include "CefViewBrowserApp/QCefCookieVisitor.h"
...
CCookieManager& CCookieManager::getInstance()
{
	static CCookieManager s_Instance;
	return s_Instance;
}

void CCookieManager::setCookie(const QString& url, const QString& key, const QString& value)
{
	CefString cef_url;
...
void CCookieManager::getUrlCookie(const QString& url, QList<TCefCookie>& cookieList)
{
	CefString cefUrl;
...
void CCookieManager::getAllCookie(QList<TCefCookie>& cookieList)
{
...
CefRefPtr<CefCookieManager> CCookieManager::getManager()
{
	return mpCookieManager;
}

QDateTime CCookieManager::CefTimeToQt(const cef_time_t& cef_time)
{
...
cef_time_t CCookieManager::QtTimeToCef(const QDateTime& dateTime)
{
	cef_time_t cef_time;
